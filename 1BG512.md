...
You have also a set of Rainforest Hunter-Gathere genomes in the datset called `RHGs`. The RHGs are what's often reffered to as Pygmies [https://en.wikipedia.org/wiki/Pygmy_peoples](https://en.wikipedia.org/wiki/Pygmy_peoples)
...
```
cd /proj/g2021011/private/PCA_LAB #Uppmax project for this course
mkdir YOURNAME
```
...
*(You also need to have bioinfo-tools loaded)*
