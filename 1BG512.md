...
In case you didn’t go through OPTIONAL 1, please copy these files into your folder, you might have to modify the command if you have a different folder structure than suggested in the lab:
